                    ...
                    if (msgBottom.orders) {
                        msgBottom.orders.forEach((val, index) => {
                            if (val.inout !== undefined) {
                                switch (Number(val.inout)) {
                                    case 1:
                                        val.inoutVal = '投注消费'; // 投注消费
                                        break;
                                    case 2:
                                        val.inoutVal = '投注中奖'; // 投注中奖
                                    case 3:
                                        val.inoutVal = '投注退款';// 投注退款
                                        break;
                                    case 4:
                                        val.inoutVal = '提款扣除'; // 提款扣除
                                    case 5:
                                        val.inoutVal = '提款手续费';// 提款手续费
                                        break;
                                    case 6:
                                        val.inoutVal = '提款失败退款';// 提款失败退款
                                    case 7:
                                        val.inoutVal = '提款失败手续退款';// 提款失败手续退款
                                    case 8:
                                        val.inoutVal = '充值';// 充值
                                    case 9:
                                        val.inoutVal = '充值失败扣款';// 充值失败扣款
                                    case 10:
                                        val.inoutVal = '注册送';// 注册送
                                    case 11:
                                        val.inoutVal = '邀请送';// 邀请送
                                }
                            }
                            if (val.total !== undefined) {
                                val.total = val.total + " ETH"
                            }
